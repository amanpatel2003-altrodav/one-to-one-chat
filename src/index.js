...
const ChatConnectionRoutes = require("./routes/chat.connection.routes");  
...
const seedChatConnections = require("./seeders/seedChatConnection");
...
app.use("/api/chatConnection", ChatConnectionRoutes); // Chat connection routes
const runSeeders = async () => {
  try {
    ...
    if (!isSeeded.isSeedChatConnections) {
      console.log("Running 'seedChatConnections'...");
      await seedChatConnections();
    }
